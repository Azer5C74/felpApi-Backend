...
exports.searchQuery = asyncHandler(async (req, res, next) => {
  ...
  businessList = await Business.find().select(
    "name location type menu hasDelivery hasBooking averageRating"
  );
  if (!businessList)
  ...
  currentLocation.longitude = 10.89031;
